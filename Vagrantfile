...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "lukedrewcodecomputerlovecom-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/zuketech"
  #   chef.validation_client_name = "zuketech-validator"
  #   chef.validation_key_path = ".chef/zuketech-validator.pem"
  # end
end
